namespace ElementalWords.Data;

public static class ElementDataMappings
{
    public static IReadOnlyDictionary<string, string> Elements { get; } = new Dictionary<string, string>
    {
